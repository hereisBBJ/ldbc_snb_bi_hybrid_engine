...
def run_script(filename,perf_file):
    ...
    perf = subprocess.Popen(["/d1/machine_performance_indicators/system_perf.py", perf_file]) 
    start = time.time()
...
def run_precomputations(query_variants, batch_id, batch_type, sf, timings_file):
    if "4" in query_variants:
        ...
        result , duration=run_script("precomp/bi-4.sql",perf_file)
    ...
    if "6" in query_variants:
        ...
        result,duration=run_script("/precomp/bi-6.sql",perf_file)
    ...
    if "19a" in query_variants or "19b" in query_variants:
        ...
        result,duration=run_script("/precomp/bi-19.sql",perf_file)
    ...
    if "20a" in query_variants or "20b" in query_variants:
        ...
        result,duration=run_script("/precomp/bi-20.sql",perf_file)
