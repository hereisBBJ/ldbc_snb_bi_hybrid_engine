/* Q20. Recruitment (full mode: build path weights in-query)
\set person2Id 32985348834889
\set company 'Express_Air'

SET VARIABLE person2Id = 32985348834889;
SET VARIABLE company = 'Express_Air';
 */
with recursive
...
srcs(f) as (select getvariable('person2Id')),
dsts(t) as (
    select personid
