...
if __name__ == '__main__':
    ...
    parser.add_argument('--container_name', type=str, help='Name or ID of the con    tainer to monitor', required=True)
    ...
    if queries_only:
        batch_type =  "power"
        run_precompute(args, timings_file, sf, batch_date, batch_type,container_name)
        run_queries(query_variants, parameter_csvs, sf, results_file, timings_file, batch_date, batch_type, args,container_name)
