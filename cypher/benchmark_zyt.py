...
import datetime
import neo4j
from queries_profile import run_queries, run_precomputations
from pathlib import Path
from itertools import cycle
import argparse

if __name__ == '__main__':
    query_variants = ["15a","15b"]
# "1", "2a", "2b", "3", "4", "5", "6", "7", "8a", "8b", "9", "10a", "10b", "11", "12", "13", "14a", "14b", "15a", "15b", "16a", "16b", "17", "18", "19a", "19b", "20a", "20b"
    ...
    if queries_only:
        batch_type = "power"
        run_precomputations(sf, query_variants, session, batch_date, batch_type, timings_file,container_name)
        reads_time = run_queries(query_variants, parameter_csvs, session, sf, batch_date, batch_type, test, pgtuning, timings_file, results_file,container_name)
